...
#include "../../../../2025_v2_rawdata/eventbuilder.h"
...
namespace {
struct qt_meta_tag_ZN12EventBuilderE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12EventBuilderE = QtMocHelpers::stringData(
    "EventBuilder",
    "sigInit",
    "",
    "sigDeinit",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12EventBuilderE[] = {
...
Q_CONSTINIT const QMetaObject EventBuilder::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12EventBuilderE.offsetsAndSizes,
    qt_meta_data_ZN12EventBuilderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12EventBuilderE_t,
        // Q_OBJECT / Q_GADGET
...
void EventBuilder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (EventBuilder::*)();
            if (_q_method_type _q_method = &EventBuilder::sigInit; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (EventBuilder::*)();
            if (_q_method_type _q_method = &EventBuilder::sigDeinit; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (EventBuilder::*)();
            if (_q_method_type _q_method = &EventBuilder::sigStartLogging; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (EventBuilder::*)();
            if (_q_method_type _q_method = &EventBuilder::sigStopLogging; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (EventBuilder::*)(int );
            if (_q_method_type _q_method = &EventBuilder::sigStartTakingHistos; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (EventBuilder::*)();
            if (_q_method_type _q_method = &EventBuilder::sigStopTakingHistos; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (EventBuilder::*)();
            if (_q_method_type _q_method = &EventBuilder::sigHistoCompleted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _q_method_type = void (EventBuilder::*)(const QByteArray & );
            if (_q_method_type _q_method = &EventBuilder::dataReady; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
...
void *EventBuilder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12EventBuilderE.stringdata0))
