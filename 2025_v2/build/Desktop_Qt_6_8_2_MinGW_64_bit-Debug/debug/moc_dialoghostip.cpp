...
#include "../../../../2025_v2_rawdata/dialoghostip.h"
...
namespace {
struct qt_meta_tag_ZN12DialogHostIpE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12DialogHostIpE = QtMocHelpers::stringData(
    "DialogHostIp",
    "showEvent",
    "",
    "QShowEvent*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12DialogHostIpE[] = {
...
Q_CONSTINIT const QMetaObject DialogHostIp::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12DialogHostIpE.offsetsAndSizes,
    qt_meta_data_ZN12DialogHostIpE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12DialogHostIpE_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogHostIp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12DialogHostIpE.stringdata0))
