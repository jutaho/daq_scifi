...
#include "../../../../2025_v2_rawdata/datareceiver.h"
...
namespace {
struct qt_meta_tag_ZN12DataReceiverE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12DataReceiverE = QtMocHelpers::stringData(
    "DataReceiver",
    "sigInit",
    "",
    "sigDeinit",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12DataReceiverE[] = {
...
Q_CONSTINIT const QMetaObject DataReceiver::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12DataReceiverE.offsetsAndSizes,
    qt_meta_data_ZN12DataReceiverE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12DataReceiverE_t,
        // Q_OBJECT / Q_GADGET
...
void DataReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DataReceiver::*)();
            if (_q_method_type _q_method = &DataReceiver::sigInit; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DataReceiver::*)();
            if (_q_method_type _q_method = &DataReceiver::sigDeinit; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (DataReceiver::*)();
            if (_q_method_type _q_method = &DataReceiver::sigConfigureEthSettings; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (DataReceiver::*)(DataReceiver * );
            if (_q_method_type _q_method = &DataReceiver::sigDataReady; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *DataReceiver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12DataReceiverE.stringdata0))
