...
#include "../../../../2025_v2_rawdata/display.h"
...
namespace {
struct qt_meta_tag_ZN10BPMDisplayE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10BPMDisplayE = QtMocHelpers::stringData(
    "BPMDisplay",
    "showEvent",
    "",
    "QShowEvent*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10BPMDisplayE[] = {
...
Q_CONSTINIT const QMetaObject BPMDisplay::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10BPMDisplayE.offsetsAndSizes,
    qt_meta_data_ZN10BPMDisplayE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10BPMDisplayE_t,
        // Q_OBJECT / Q_GADGET
...
void *BPMDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10BPMDisplayE.stringdata0))
