...
#include "../../../../2025_v2_rawdata/dialoglogsettings.h"
...
namespace {
struct qt_meta_tag_ZN17DialogLogSettingsE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17DialogLogSettingsE = QtMocHelpers::stringData(
    "DialogLogSettings",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17DialogLogSettingsE[] = {
...
Q_CONSTINIT const QMetaObject DialogLogSettings::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17DialogLogSettingsE.offsetsAndSizes,
    qt_meta_data_ZN17DialogLogSettingsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17DialogLogSettingsE_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogLogSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17DialogLogSettingsE.stringdata0))
